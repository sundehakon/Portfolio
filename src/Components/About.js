        ...
        <Box>
            ...
            <Grid container spacing={3} justifyContent="center" sx={{ marginBottom: 10 }}>
                ...
                <Grid item xs={12} sm={6} md={4}>
                    ...
                    <Typography>
                        I was born on November 16, 2006, in Oslo, Norway. I've lived in Lillestrøm, Ekelundsstien 25 most of my life, a medium-sized city just outside Oslo. I started programming a few years ago, influenced by school and social media. Now, I code every day for school!
                    </Typography>
                </Grid>
                {isSmallScreen && <Grid item xs={12} sx={{ height: 16 }} />}
                <Grid item xs={12} sm={6} md={4}>
