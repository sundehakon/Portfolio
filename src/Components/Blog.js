...
const Blog = () => {
    ...
    return (
        <div>
            <Box sx={{ backgroundColor: '#fcfcfc', width: '100%', marginTop: 5, paddingBottom: 5 }}>
                            ...
                            {blogs.map((blog, index) => (
                                <Grid item key={index} xs={12} sm={6} md={4} lg={3}>
                                    ...
                                    >
                                        ...
                                        <Typography>{new Date(blog.date).toLocaleDateString()}</Typography>
                                    </Paper>
                                </Grid>
                            ))}
                        </Grid>
                ...
                <Modal open={selectedBlog !== null} onClose={handleClose}>
                    <Box
                        ...
                        <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', marginTop: 2 }}>
                            ...
                            <Typography>{new Date(selectedBlog?.date).toLocaleDateString()}</Typography>
                        </Box>
                            ...
                            <>
                                ...
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flexDirection: isMobile ? 'column' : 'row' }}>
                                    <TextField
                                        variant='outlined'
                                        label='Write comment'
                                        sx={{ marginTop: 3, width: isMobile ? '100%' : '80%' }}
